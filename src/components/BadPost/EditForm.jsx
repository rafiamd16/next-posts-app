...
// const EditBadForm = ({ badPost }) => {
//   const [name, setName] = useState(badPost.name || "");
//   const [message, setMessage] = useState(badPost.message || "");
...
//             className={`outline-none shadow text-sm text-gray-700 py-3 px-4 w-full focus:ring-2 focus:ring-offset-1 focus:ring-blue-700 focus:border-blue-700 transition-all duration-300 ease-in-out rounded ${
...
//             className={`outline-none shadow text-sm text-gray-700 py-2 h-[120px] px-4 w-full focus:ring-2 focus:ring-offset-1 focus:ring-blue-700 focus:border-blue-700 transition-all duration-300 ease-in-out rounded ${
